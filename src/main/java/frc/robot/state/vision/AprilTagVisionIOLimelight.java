...
public class AprilTagVisionIOLimelight implements AprilTagVisionIO {
        ...
        public void updateInputs(AprilTagVisionIOInputs inputs) {
                Rotation3d rotation = new Rotation3d(
                                0.0, 0.0,
                                RobotStateEstimator.getInstance().getEstimatedPose().getRotation().getRadians());
                ...
                double rotationalSpeed = Math
                                .abs(RobotContainer.m_swerve.getCurrentFieldChassisSpeeds().omegaRadiansPerSecond);
