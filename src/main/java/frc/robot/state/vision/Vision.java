        ...
        public void periodic() {
                ...
                for (int instanceIndex = 0; instanceIndex < io.length; instanceIndex++) {
                        ...
                        Pose3d cameraPose3d = robotPose3d
                                        .transformBy(GeometryUtil
                                                        .pose3dToTransform3d(robotToCameraPoses[instanceIndex]));
                        ...
                        double rotationalSpeed = Math.abs(
                                        RobotContainer.m_swerve.getCurrentFieldChassisSpeeds().omegaRadiansPerSecond);
                        ...
                        allVisionObservations.add(
                                        new VisionObservation(
                                                        robotPose3d.toPose2d(), timestamp,
                        ...
                        Logger.recordOutput("AprilTagVision/" + instanceNames[instanceIndex] + "/RobotPose3d",
                                        robotPose3d);
                        Logger.recordOutput(
                                        "AprilTagVision/" + instanceNames[instanceIndex] + "/TagPoses",
