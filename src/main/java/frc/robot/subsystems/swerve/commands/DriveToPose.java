...
public class DriveToPose extends Command {
        ...
        static {
                drivekP.initDefault(SwerveConstants.PID.kTranslationkP);
                drivekD.initDefault(0.0);
                thetakP.initDefault(SwerveConstants.PID.kRotationkP);
                thetakD.initDefault(0.0);
                driveMaxVelocity.initDefault(SwerveConstants.kTrueMaxSpeed * 0.5);
        ...
        public void initialize() {
                ...
                ChassisSpeeds fieldVelocity = drive.getCurrentFieldChassisSpeeds();
        ...
        public void execute() {
                ...
                driveVelocity = driveVelocity.interpolate(linearFF.get().times(SwerveConstants.kTrueMaxSpeed), linearS);
        ...
        public void end(boolean interrupted) {
                drive.setControl(driveNoHeading.withVelocityX(0.0).withVelocityY(0.0).withRotationalRate(0.0));
                running = false;
                // Clear logs
