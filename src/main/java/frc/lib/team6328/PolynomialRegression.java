...
// /**
// * The {@code PolynomialRegression} class performs a polynomial regression on
// an set of <em>N</em>
...
// equal
// */
// public PolynomialRegression(double[] x, double[] y, int degree, String
// variableName) {
// this.degree = degree;
